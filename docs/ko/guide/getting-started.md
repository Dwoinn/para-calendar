...
```sh
npm install @dwoinn/para-calendar # 최신 버전
npm install @dwoinn/para-calendar@<version> # 2.0 이후 특정 버전
...
```js
/* Node.js 환경에서 ES6 모듈 */
import '@dwoinn/para-calendar/dist/para-calendar.min.css'; // Calendar 스타일
```
