...
[![npm version](https://img.shields.io/npm/v/@dwoinn/para-react-calendar.svg)](https://www.npmjs.com/package/@dwoinn/para-react-calendar)
...
```sh
npm install --save @dwoinn/para-react-calendar
```
