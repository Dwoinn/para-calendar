...
[![npm version](https://img.shields.io/npm/v/@para-calendar/react-calendar.svg)](https://www.npmjs.com/package/@para-calendar/react-calendar)
...
```sh
npm install --save @para-calendar/react-calendar
```
